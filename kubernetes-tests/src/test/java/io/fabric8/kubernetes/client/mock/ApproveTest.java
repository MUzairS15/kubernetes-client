...
public class ApproveTest {
  ...
  KubernetesClient client;
    ...
    public void testApprove() throws MalformedURLException {
      ...
      //Then
      Assert.assertEquals(client.certificates().v1().certificateSigningRequests().withName("my-cert").get().getStatus(), "True");
    ...
    public void testDeny() throws MalformedURLException {
      ...
      //Then
      Assert.assertEquals(client.certificates().v1().certificateSigningRequests().withName("my-cert").get().getStatus(), "False");
